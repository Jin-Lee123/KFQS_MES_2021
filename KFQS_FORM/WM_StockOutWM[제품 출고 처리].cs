...
namespace KFQS_Form
{
    public partial class WM_StockOutWM : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void WM_StockOutWM_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "CHK",            "출고 등록",      true, GridColDataType_emu.CheckBox,    80, 120, Infragistics.Win.HAlign.Left,    true, true);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "PLANTCODE",      "공장",        true, GridColDataType_emu.VarChar,   80, 120, Infragistics.Win.HAlign. Left,   false, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "LOTNO",           "LOTNO",      true, GridColDataType_emu.VarChar,   140, 120, Infragistics.Win.HAlign.Left,   true, false);
            ...
            _GridUtil.InitColumnUltraGrid(grid2, "SHIPQTY",         "상차수량",   true, GridColDataType_emu.Double,    120, 120, Infragistics.Win.HAlign.Right,  true, false);
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("16WM_StockOutWM_S1", CommandType.StoredProcedure
                                    , helper.CreateParameter("PLANTCODE",   sPlantCode,  DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("CUSTCODE",    sCustCode,   DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("STARTDATE",   sStartDate,  DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("ENDDAETE",    sEndDate,    DbType.String, ParameterDirection.Input)
                ...
                foreach (DataRow drRow in dt.Rows)
                {
                    switch (drRow.RowState)
                    {
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("16WM_StockOutWM_U1", CommandType.StoredProcedure
        ...
        private void grid1_AfterRowActivate(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("16WM_StockOutWM_S2", CommandType.StoredProcedure
                                    , helper.CreateParameter("PLANTCODE", sPlantCode, DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("SHIPNO", sShipNo, DbType.String, ParameterDirection.Input)
                                    );
