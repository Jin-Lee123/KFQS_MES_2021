    ...
    public partial class AP_ProductPlan : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void DoFind()
        {
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("16AP_ProductPlan_S1", CommandType.StoredProcedure
                                    , helper.CreateParameter("PLANTCODE",       sPlantCode,        DbType.String, ParameterDirection.Input)
                                    , helper.CreateParameter("WORKCHENTERCODE", sWorkCenterCode,   DbType.String, ParameterDirection.Input)
                ...
                foreach (DataRow drRow in dtTemp.Rows)
                {
                    switch (drRow.RowState)
                    {
                        case DataRowState.Deleted:
                            #region 삭제
                            drRow.RejectChanges();
                            helper.ExecuteNoneQuery("16AP_ProductPlan_D1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Added:
                            ...
                            helper.ExecuteNoneQuery("16AP_ProductPlan_I1", CommandType.StoredProcedure
                        ...
                        case DataRowState.Modified:
                            ...
                            helper.ExecuteNoneQuery("16AP_ProductPlan_U1", CommandType.StoredProcedure
                                                  , helper.CreateParameter("PLANTCODE", drRow["PLANTCODE"].ToString(), DbType.String, ParameterDirection.Input)
