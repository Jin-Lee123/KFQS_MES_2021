...
namespace KFQS_Form
{
    public partial class WM_ProdInStock : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void WM_ProdInStock_Load(object sender, EventArgs e)
        {
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "LOTNO",       "LOTNO",    true, GridColDataType_emu.VarChar,   100, 100, Infragistics.Win.HAlign.Left,   true, false);
        ...
        {   
            ...
            try
            {
                ...
                rtnDtTemp = helper.FillTable("16WM_ProdInStock_S1", CommandType.StoredProcedure
        ...
        public override void DoSave()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++ )
                {
                    ...
                    helper.ExecuteNoneQuery("16WM_ProdInStock_U1"
